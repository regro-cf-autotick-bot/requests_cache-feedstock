...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/requests_cache-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `requests_cache` can be installed with:

```
conda install requests_cache
```

It is possible to list all of the versions of `requests_cache` available on your platform with:
